    ...
    function pairName(
        ...
        return
            string(
                abi.encodePacked(
                    prefix,
                    SafeKRC20Namer.tokenName(token0),
                    TOKEN_SEPARATOR,
                    SafeKRC20Namer.tokenName(token1),
                    suffix
                )
            );
    }
    ...
    function pairSymbol(
        ...
        return
            string(
                abi.encodePacked(
                    TOKEN_SYMBOL_PREFIX,
                    SafeKRC20Namer.tokenSymbol(token0),
                    TOKEN_SEPARATOR,
                    SafeKRC20Namer.tokenSymbol(token1),
                    suffix
                )
            );
    }
